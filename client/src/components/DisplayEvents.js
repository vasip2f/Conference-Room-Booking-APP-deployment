...
import "../components/FontAwesomicon/index";
...
export default function () {
    ...
    return (
        ...
        <div>
            ...
            {/* <div>
                <Popup trigger=
                    {<Button varient='warning'><i className='fa fa-plu'></i>Schedule Meeting</Button>}
                    position="bottom right" backgroundColor="White">
                    <div>
                        <form onSubmit={handleclick} style={{ backgroundColor: "silver" }}>
                            ...
                            <div>
                                ...
                                <Datetime type='datetime-local' value={StartTime} onChange={date => setStartTime(date)} required='Start time is misiing' />
                            </div>
                            <div>
                                <label className='text-darkBlack'>EndTime</label>
                                <Datetime type='datetime-local' value={EndTime} onChange={date => setEndTime(date)} required='End Time is Missing' />
                            </div>
                    ...
                    <FullCalendar
                        ...
                        eventDidMount={(info) => {
                            return new bootstrap.Popover(info.el, {
                                ...
                                content: "<p>hi<strong>your event</strong>.</p>",
                                html: true,
                            });
                        }}
                    />
